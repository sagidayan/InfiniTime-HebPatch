#include "displayapp/screens/WatchFaceDigitalHeb.h"
...
WatchFaceDigitalHeb::WatchFaceDigitalHeb(Controllers::DateTime& dateTimeController,
...
WatchFaceDigitalHeb::~WatchFaceDigitalHeb() {
  lv_task_del(taskRefresh);
  lv_obj_clean(lv_scr_act());
}

void WatchFaceDigitalHeb::Refresh() {
  statusIcons.Update();
    ...
    if (currentDate.IsUpdated()) {
      ...
      if (settingsController.GetClockType() == Controllers::Settings::ClockType::H24) {
        lv_label_set_text_fmt(label_date,
                              "יום %s\nה-%d ל%s %d",
                              dateTimeController.DayOfWeekShortToHebString(),
                              day,
                              dateTimeController.MonthShortToHebString(),
                              year);
      } else {
        lv_label_set_text_fmt(label_date,
                              "%s %s %d %d",
